    ...
    Returns:
        tuple[torch.Tensor, dict[str, float]].
            ...
            metadata
                ...
                of rewards).
    """
    from cs336_alignment.utils import compute_group_normalized_rewards
...
def run_compute_policy_gradient_loss(
    ...
    """
    from cs336_alignment.utils import compute_policy_gradient_loss
...
def run_aggregate_loss_across_microbatch(
    ...
    """
    from cs336_alignment.utils import aggregate_loss_across_microbatch
...
def run_grpo_train_step(
    ...
    return grpo_train_step(
        ...
        importance_reweighting_method, old_log_probs, cliprange, loss_normalization
    )
